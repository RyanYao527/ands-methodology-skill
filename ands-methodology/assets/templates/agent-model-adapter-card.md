...
- Not fit without Enterprise review: `[API integration / real data / automated writeback / benchmark claims]`
...
If the adapter card produces reusable runtime guidance, write back only the generic rule. Keep provider-specific trial facts in the project until they are reviewed.
