...
- External delivery or contractual impact: `[无 / 外部可见但无敏感数据、公开声明和客户承诺 / 有公开声明、合同、合规、客户承诺、provider 对比、采购建议或真实客户影响]`
...
- [ ] 有明确 Gate 3 人验收角色。
- [ ] 失败动作能在当前团队内闭环。
- [ ] 外部可见但低风险，且不涉及敏感数据、真实客户影响、生产关键路径、跨团队接口、合同义务、客户承诺、公开声明、provider 对比、采购建议或难回滚时，默认 Standard，并加强 Gate 4 审查。
...
- [ ] 涉及重大架构决策或长期标准变更。
- [ ] 涉及自动化批量改写、公开声明、provider 对比、采购建议或未脱敏真实材料。公开发布脱敏 examples、模板或教学材料本身不自动升级；若无公开声明或客户承诺，可按 Standard + 加强 Gate 4 处理。
...
- [ ] 外部交付从低风险展示变成合同、客户承诺、公开声明、provider 对比、采购建议或真实客户影响。
